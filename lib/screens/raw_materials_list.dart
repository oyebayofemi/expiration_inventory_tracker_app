...
class ShowAllItemsRawMaterials extends StatefulWidget {
  ShowAllItemsRawMaterials({Key? key}) : super(key: key);

  @override
  State<ShowAllItemsRawMaterials> createState() =>
      _ShowAllItemsRawMaterialsState();
}

class _ShowAllItemsRawMaterialsState extends State<ShowAllItemsRawMaterials> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text('Raw Materials Items'),
      ),
      body: StreamBuilder<QuerySnapshot?>(
        stream: itemcollections
            .doc(userID)
            .collection('items')
            .where('category', isEqualTo: 'Raw Materials')
            .snapshots(),
