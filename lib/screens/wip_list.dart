...
class ShowAllItemsFinishedWIP extends StatefulWidget {
  ShowAllItemsFinishedWIP({Key? key}) : super(key: key);

  @override
  State<ShowAllItemsFinishedWIP> createState() =>
      _ShowAllItemsFinishedWIPState();
}

class _ShowAllItemsFinishedWIPState extends State<ShowAllItemsFinishedWIP> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text('Work in Progress(WIP) Items'),
      ),
      body: StreamBuilder<QuerySnapshot?>(
        stream: itemcollections
            .doc(userID)
            .collection('items')
            .where('category', isEqualTo: 'Work In Progress (WIP)')
            .snapshots(),
